        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li class="dropdown">
                        <a id="them" data-toggle="modal" data-target=".modal-sanpham" href="#"
                    ...
                    <li class="dropdown">
                        <a id="suas" href="#" class="btn disabled btn-info btn-sm">
                            <i class="fa fa-pencil"></i>
                            Sửa thông tin đại lý
                        </a>
                    </li>
                    <li class="dropdown">
                        <a id="xoa" href="#" class="btn disabled btn-danger btn-sm">
            ...
            <div class="x_content">
                ...
                <table id="bang-dailys" class="table table-striped table-bordered jambo_table">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Mã đại lý</th>
